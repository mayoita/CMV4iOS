...
{
    _indicatorBackground = [[UIView alloc] initWithFrame:CGRectMake(_scrollView.frame.size.width-(kOverlayWidth + 2),
                                                                    _scrollView.frame.size.height-kOverlayHeight - 3,
                                                                    kOverlayWidth,
                                                                    kOverlayHeight)];
...
//                    }
//                }
                //Asynchronously retrieve image FireBase
                FIRStorageReference *starsRef = [self.storageRef child:[aImageUrls objectAtIndex:i]];
